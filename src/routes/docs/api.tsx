    ...
    return (
        ...
        >
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
                API keys are managed via <code className="text-primary">/api/v1/keys</code>. These endpoints use <strong>session auth</strong> (cookies from the web UI login), not API key auth.
            </p>
            ...
            <p className="text-sm text-muted-foreground mt-2 p-3 rounded-md bg-destructive/10 border border-destructive/20">
                <strong>Important:</strong> The <code className="text-primary">secretKey</code> is shown <strong>only once</strong>. Store it securely.
            </p>
            ...
            <p className="text-sm text-muted-foreground mb-4">
                All bucket endpoints require API key auth when <code className="text-primary">-api-auth</code> is enabled.
            </p>
            ...
            <p className="text-sm text-muted-foreground">
                <strong>Naming rules (S3-compatible):</strong> 3–63 chars, lowercase letters/numbers/hyphens/dots, must start and end with letter or number, cannot be an IP address format.
            </p>
            ...
            <DocTable
                ...
                rows={[
                    ...
                    ["delimiter", "(none)", "Group keys by delimiter (e.g., / for virtual dirs)"],
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                <li>OpenAPI Specification: <code className="text-primary">docs/openapi.yaml</code></li>
                <li>Postman Collection: <code className="text-primary">docs/beamdrop-api.postman_collection.json</code></li>
                <li>Postman Guide: <code className="text-primary">docs/POSTMAN-GUIDE.md</code></li>
                <li>API Design: <code className="text-primary">docs/s3-api-design.md</code></li>
                <li>Security: <code className="text-primary">docs/SECURITY.md</code></li>
            </ul>
        </DocPage>
    );
}
