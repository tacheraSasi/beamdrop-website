...
function TypeScriptGuidePage() {
  return (
    ...
    >
      ...
      <CodeBlock title="beamdrop.ts — base helper">
      ...
      <CodeBlock title="Authentication">
      ...
      <CodeBlock title="List, upload, download, manage files">
      ...
      <CodeBlock title="Upload, download, list objects">
      ...
      <CodeBlock title="Create, list, delete API keys">
      ...
      <CodeBlock title="Client-side HMAC presigned URL">
      ...
      <CodeBlock title="Server-side pretty URLs">
      ...
      <CodeBlock title="Create, access, delete shares">
      ...
      <CodeBlock title="Health, stats, logs">
