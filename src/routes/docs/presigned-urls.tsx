    ...
    return (
        ...
        >
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
                Generate a self-contained URL with a time-limited token. No server call needed. Anyone with the link can access the file until it expires.
            </p>
            ...
            <DocTable
                ...
                rows={[
                    ...
                    ["expires", "2026-02-12T12:00:00Z", "When the link expires (RFC 3339 or compact ISO)"],
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground text-sm">
                <li><strong>Always expires</strong> — there is no "permanent" presigned URL</li>
                <li><strong>Tied to API key</strong> — deleting/disabling the key invalidates all URLs generated with it</li>
                <li><strong>Method-specific</strong> — a token for GET will not work for PUT</li>
                <li><strong>Key-specific</strong> — a token for one object cannot be reused for another</li>
                <li><strong>No maximum expiry</strong> — you can set expiry far in the future, but it breaks on key rotation</li>
                <li><strong>No individual revocation</strong> — to invalidate a leaked URL, delete the object or disable the API key</li>
            </ul>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
                In addition to client-side HMAC URLs, Beamdrop supports a server-side presigned URL registry that produces short, clean <code className="text-primary">/dl/&#123;token&#125;</code> URLs.
            </p>
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                <li><strong>Run without <code className="text-primary">-api-auth</code></strong> — all S3 API reads are public</li>
                <li><strong>Proxy through your app</strong> — your backend authenticates to Beamdrop and streams the file to end users</li>
                <li><strong>Use shareable links</strong> — the <code className="text-primary">/api/shares</code> feature provides token-based sharing with optional password protection and expiry</li>
            </ol>
        </DocPage>
    );
}
